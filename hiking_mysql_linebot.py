        ...
        if type == "text":
            ...
            if msg == "好呀<3":
                ...
                if not mount_df.empty:
                    msg_name = mount_df.iat[0,0]
                    # print(msg_name)
                    msg_score = mount_df.iat[0,2]
                    # print(msg_score)
                    msg_place = hiking_location()
                    # print(msg_place)
                    msg_difficulty = hiking_difficulty()
                    # print(msg_difficulty)
                    msg_distance = str(int(mount_df.iat[0,20]))
                    # print(msg_distance)
                    msg_time = mount_df.iat[0,21]
                    # print(msg_time)
                    msg_altitude = str(str(int(mount_df.iat[0,26]))+" ~ "+str(int(mount_df.iat[0,27])))
                    # print(msg_altitude)
                    msg_height_diff = str(int(mount_df.iat[0,28]))
                    # print(msg_height_diff)
                    msg_website = mount_df.iat[0,1]
                    # print(msg_website)
...
def hiking_location():
    ...
    if mount_df.iat[0,4] == "-":
        mount_location = mount_df.iat[0,3]
    else:
        if mount_df.iat[0,5] == "-":
            mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]
        else:
            if mount_df.iat[0,6] == "-":
                mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]
            else:
                if mount_df.iat[0,7] == "-":
                    mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]
                else:
                    if mount_df.iat[0,8] == "-":
                        mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]
                    else:
                        if mount_df.iat[0,9] == "-":
                            mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]
                        else:
                            if mount_df.iat[0,10] == "-":
                                mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]
                            else:
                                if mount_df.iat[0,11] == "-":
                                    mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]
                                else:
                                    if mount_df.iat[0,12] == "-":   
                                        mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0j,11]
                                    else:
                                        if mount_df.iat[0,13] == "-":  
                                            mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]
                                        else:
                                            if mount_df.iat[0,14] == "-":
                                                mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]
                                            else:
                                                if mount_df.iat[0,15] == "-":
                                                    mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]+mount_df.iat[0,14]
                                                else:
                                                    if mount_df.iat[0,16] == "-":
                                                        mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]+mount_df.iat[0,14]+"\n"+mount_df.iat[0,15]
                                                    else:
                                                        if mount_df.iat[0,17] == "-":
                                                            mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]+mount_df.iat[0,14]+"\n"+mount_df.iat[0,15]+mount_df.iat[0,16]
                                                        else:
                                                            if mount_df.iat[0,18] == "-":
                                                                mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]+mount_df.iat[0,14]+"\n"+mount_df.iat[0,15]+mount_df.iat[0,16]+"\n"+mount_df.iat[0,17]
                                                            else:
                                                                mount_location = mount_df.iat[0,3]+mount_df.iat[0,4]+"\n"+mount_df.iat[0,5]+mount_df.iat[0,6]+"\n"+mount_df.iat[0,7]+mount_df.iat[0,8]+"\n"+mount_df.iat[0,9]+mount_df.iat[0,10]+"\n"+mount_df.iat[0,11]+mount_df.iat[0,12]+"\n"+mount_df.iat[0,13]+mount_df.iat[0,14]+"\n"+mount_df.iat[0,15]+mount_df.iat[0,16]+"\n"+mount_df.iat[0,17]+mount_df.iat[0,18]
    return mount_location

def hiking_difficulty():
    global mount_difficulty
    if str(mount_df.iat[0,19]) == "1":
        mount_difficulty = "低"
    elif str(mount_df.iat[0,19]) == "2":
        mount_difficulty = "低-中"
    elif str(mount_df.iat[0,19]) == "3":
        mount_difficulty = "中"
    elif str(mount_df.iat[0,19]) == "4":
        mount_difficulty = "中-高"
    elif str(mount_df.iat[0,19]) == "5":
        mount_difficulty = "高"
