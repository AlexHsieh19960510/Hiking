...
class Main_Window(QWidget):
    ...
    def search_result_window(self):
        ...
        for j in range(len(Final_df[0:10])):
            if Final_df.iat[j,5] == "-":
                Line_location = Final_df.iat[j,4]
            else:
                if Final_df.iat[j,6] == "-":
                    Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]
                else:
                    if Final_df.iat[j,7] == "-":
                        Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]
                    else:
                        if Final_df.iat[j,8] == "-":
                            Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]
                        else:
                            if Final_df.iat[j,9] == "-":
                                Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]
                            else:
                                if Final_df.iat[j,10] == "-":
                                    Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]
                                else:
                                    if Final_df.iat[j,11] == "-":
                                        Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]
                                    else:
                                        if Final_df.iat[j,12] == "-":
                                            Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]
                                        else:
                                            if Final_df.iat[j,13] == "-":   
                                                Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]
                                            else:
                                                if Final_df.iat[j,14] == "-":  
                                                    Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]
                                                else:
                                                    if Final_df.iat[j,15] == "-":
                                                        Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]
                                                    else:
                                                        if Final_df.iat[j,16] == "-":
                                                            Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]+Final_df.iat[j,15]
                                                        else:
                                                            if Final_df.iat[j,17] == "-":
                                                                Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]+Final_df.iat[j,15]+"\n"+Final_df.iat[j,16]
                                                            else:
                                                                if Final_df.iat[j,18] == "-":
                                                                    Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]+Final_df.iat[j,15]+"\n"+Final_df.iat[j,16]+Final_df.iat[j,17]
                                                                else:
                                                                    if Final_df.iat[j,19] == "-":
                                                                        Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]+Final_df.iat[j,15]+"\n"+Final_df.iat[j,16]+Final_df.iat[j,17]+"\n"+Final_df.iat[j,18]
                                                                    else:
                                                                        Line_location = Final_df.iat[j,4]+Final_df.iat[j,5]+"\n"+Final_df.iat[j,6]+Final_df.iat[j,7]+"\n"+Final_df.iat[j,8]+Final_df.iat[j,9]+"\n"+Final_df.iat[j,10]+Final_df.iat[j,11]+"\n"+Final_df.iat[j,12]+Final_df.iat[j,13]+"\n"+Final_df.iat[j,14]+Final_df.iat[j,15]+"\n"+Final_df.iat[j,16]+Final_df.iat[j,17]+"\n"+Final_df.iat[j,18]+Final_df.iat[j,19]
            if str(Final_df.iat[j,20]) == "1":
                Line_difficulty = "低"
            elif str(Final_df.iat[j,20]) == "2":
                Line_difficulty = "低-中"
            elif str(Final_df.iat[j,20]) == "3":
                Line_difficulty = "中"
            elif str(Final_df.iat[j,20]) == "4":
                Line_difficulty = "中-高"
            elif str(Final_df.iat[j,20]) == "5":
                Line_difficulty = "高"
            bubble = {
        "type": "bubble",
        "hero": {
            "type": "image",
            "url": str(Final_df.iat[j,26]),
            "size": "full",
            "aspectRatio": "20:13",
            "aspectMode": "cover",
            "action": {
            "type": "uri",
            "uri": str(Final_df.iat[j,2])
            }
        },
        "body": {
            "type": "box",
            ...
            },
            {
                ...
                },
                {
                    ...
                    {
                        "type": "text",
                        "text": str(int(Final_df.iat[j,21]))+"公里",
                        "wrap": True,
                        "color": "#666666",
                        "size": "sm",
                        "flex": 5,
                ...
                },
                {
                    ...
                    {
                        "type": "text",
                        "text": str(str(int(Final_df.iat[j,27]))+" ~ "+str(int(Final_df.iat[j,28]))+"公尺"),
                        "wrap": True,
                        "color": "#666666",
                        "size": "sm",
                        "flex": 5,
                ...
                },
                {
                    ...
                    {
                        "type": "text",
                        "text": str(int(Final_df.iat[j,29]))+"公尺",
                        "wrap": True,
                        "color": "#666666",
                        "size": "sm",
                        "flex": 5,
        ...
        # }
        # }
        #     line_bot_api.push_message("U6a3ba421ceaeff0c96b0d7fbb53c09d1", FlexSendMessage(alt_text = str(Final_df.iat[j,1]),contents = bubble))
